...
static const Rule rules[] = {
	...
	{ "steam_app_0",     NULL,      NULL,       1 << 2,          0,             0,            0,            0,          -1 },
	{ thunderbird,       NULL,      NULL,       1 << 3,          3,             0,            0,            0,          -1 },
	{ "TelegramDesktop", NULL,      NULL,       1 << 3,          4,             0,            0,            0,          -1 },
	{ "Signal",          NULL,      NULL,       1 << 3,          4,             0,            0,            0,          -1 },
...
static Keychord keychords[] = {
	...
	{ 1, {{ MODKEY, XK_s }},                      spawn,            {.v = (const char*[]){ "kitty", "-e", "pavucontrol", NULL } } },
	...
	{ 1, {{ MODKEY, XK_b }},                      spawn,            {.v = (const char*[]){ "rofi-bluetooth", NULL } } },
	{ 1, {{ MODKEY, XK_n }},                      spawn,            {.v = (const char*[]){ "rofi_notes.sh", NULL } } },
	{ 1, {{ MODKEY|ShiftMask, XK_q }},            spawn,            {.v = (const char*[]){ "rofi-power", NULL } } },
	{ 1, {{ MODKEY|Mod1Mask|ControlMask, XK_q }}, quit,             {1} }, 
	{ 1, {{ MODKEY|ControlMask, XK_a }},          spawn,            {.v = (const char*[]){ "autorecord", NULL } } },
	...
	{ 1, {{ MODKEY|Mod1Mask|ControlMask, XK_r }}, spawn,            {.v = (const char*[]){ "recording-start-audio", NULL } } },
